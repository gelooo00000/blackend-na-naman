                ...
                <div class="p-6">
                    <form action="{{ route('students.update', $student) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="course" class="block mt-1 w-full" type="text" name="course" :value="old('course', $student->course)" />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status" name="status" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="0" {{ !old('status', $student->status) ? 'selected' : '' }}>Inactive</option>
                            </select>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('students.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
